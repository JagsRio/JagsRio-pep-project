...
The ConnectionUtil provided uses a singleton, and using a try-with-resources will cause issues in the tests. Checking Save to verify
It is commiting fully.